...
void Stereo::setupRectQueue(std::shared_ptr<dai::Device> device,
    ...
    // Get QoS settings from driver parameters
    auto node = getROSNode();
    try {
        pubConfig.qosReliability = node->get_parameter("driver.i_qos_reliability").as_string();
    } catch (const rclcpp::exceptions::ParameterNotDeclaredException& e) {
        pubConfig.qosReliability = "reliable";  // default
    }
    try {
        pubConfig.qosDurability = node->get_parameter("driver.i_qos_durability").as_string();
    } catch (const rclcpp::exceptions::ParameterNotDeclaredException& e) {
        pubConfig.qosDurability = "volatile";  // default
    }
    try {
        pubConfig.qosHistory = node->get_parameter("driver.i_qos_history").as_string();
    } catch (const rclcpp::exceptions::ParameterNotDeclaredException& e) {
        pubConfig.qosHistory = "keep_last";  // default
    }
    try {
        pubConfig.qosDepth = node->get_parameter("driver.i_qos_depth").as_int();
    } catch (const rclcpp::exceptions::ParameterNotDeclaredException& e) {
        pubConfig.qosDepth = 10;  // default
    }
...
void Stereo::setupStereoQueue(std::shared_ptr<dai::Device> device) {
    ...
    auto node = getROSNode();
    try {
        pubConf.qosReliability = node->get_parameter("driver.i_qos_reliability").as_string();
    } catch (const rclcpp::exceptions::ParameterNotDeclaredException& e) {
        pubConf.qosReliability = "reliable";  // default
    }
    try {
        pubConf.qosDurability = node->get_parameter("driver.i_qos_durability").as_string();
    } catch (const rclcpp::exceptions::ParameterNotDeclaredException& e) {
        pubConf.qosDurability = "volatile";  // default
    }
    try {
        pubConf.qosHistory = node->get_parameter("driver.i_qos_history").as_string();
    } catch (const rclcpp::exceptions::ParameterNotDeclaredException& e) {
        pubConf.qosHistory = "keep_last";  // default
    }
    try {
        pubConf.qosDepth = node->get_parameter("driver.i_qos_depth").as_int();
    } catch (const rclcpp::exceptions::ParameterNotDeclaredException& e) {
        pubConf.qosDepth = 10;  // default
    }
