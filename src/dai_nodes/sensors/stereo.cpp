...
void Stereo::setupRectQueue(std::shared_ptr<dai::Device> device,
    ...
    // QoS configuration
    pubConfig.qosReliability = ph->getParam<std::string>("i_qos_reliability");
    pubConfig.qosDurability = ph->getParam<std::string>("i_qos_durability");
    pubConfig.qosHistoryDepth = ph->getParam<int>("i_qos_history_depth");
...
void Stereo::setupStereoQueue(std::shared_ptr<dai::Device> device) {
    ...
    // QoS configuration
    pubConf.qosReliability = ph->getParam<std::string>("i_qos_reliability");
    pubConf.qosDurability = ph->getParam<std::string>("i_qos_durability");
    pubConf.qosHistoryDepth = ph->getParam<int>("i_qos_history_depth");
